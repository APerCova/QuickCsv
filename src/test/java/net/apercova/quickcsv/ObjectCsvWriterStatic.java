...
public class ObjectCsvWriterStatic {
    ...
    public void test01() throws Exception {
        ...
        try {
            ...
            ObjectCsvWriter.write(Country.class, writer, countries);
            writer.flush();
            ...
            writer = new StringWriter();
            ObjectCsvWriter.write(Country.class, writer, countries, true);
            writer.flush();
            ...
            writer = new StringWriter();
            ObjectCsvWriter.write(Country.class, writer, countries, CsvCons.PIPE, CsvCons.SINGLE_QUOTE, true);
            writer.flush();
